...
public class TokenInfos {
    ...
    private LocalDateTime expireDate = LocalDateTime.now().plusMinutes(1);//speichert die Zeit, an dem der Token abläuft (15 min nach der letzten Verwendung des Token)
}
