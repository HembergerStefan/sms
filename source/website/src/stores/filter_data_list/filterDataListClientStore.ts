...
export interface FilterDataListClientStore {
    table: any
...
const useFilterDataListClientStore = create(
    persist<FilterDataListClientStore>((set, get) => ({
            table: null,
            filterPageSize: 10,
            filterPageIndex: 0,
            filterPageCount: 0,
            ...
            name: 'filter-data-list-client-store',
            storage: createJSONStorage(() => sessionStorage)
        }
    )
)

export default useFilterDataListClientStore